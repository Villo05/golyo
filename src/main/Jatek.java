...
public class Jatek extends javax.swing.JFrame {
    ...
    private void gombKezelo (JButton kivalasztottGomb){
        ...
        String Szoveg = ikon.toString();
            int utolso = Szoveg.lastIndexOf('/');
            char kepElsoBetuje = Szoveg.charAt(utolso + 1);
            aktiv = kepElsoBetuje+"";        
